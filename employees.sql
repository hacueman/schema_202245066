...
CREATE TABLE `employees` (
  `employee_id` char(3) COLLATE utf8mb4_general_ci NOT NULL,
  `name` varchar(20) COLLATE utf8mb4_general_ci NOT NULL,
  `english_name` varchar(20) COLLATE utf8mb4_general_ci DEFAULT NULL,
  ...
  `manager_id` char(3) COLLATE utf8mb4_general_ci DEFAULT NULL,
  `department_id` char(2) COLLATE utf8mb4_general_ci DEFAULT NULL,
